...
router.post("/register/new",registrations.create);
...
router.post("/polls/new/create",middlewares.requireUser,polls.create);
router.get("/polls/:id",polls.poll);
router.patch("/polls/:id/vote",polls.vote);
router.delete('/polls/:id/delete',middlewares.requireUser,polls.delete);
